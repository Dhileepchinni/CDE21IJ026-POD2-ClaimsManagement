...
class AuthenticationRequestTest
{
   ...
   void authenticationRequestNotNullTest(){
	...
	void testUserLoginAllArgs() {
		AuthenticationRequest authenticationRequest = new AuthenticationRequest("Dhileep", "chinni2122");
		assertEquals("Dhileep", authenticationRequest.getUsername());
		assertEquals("chinni2122", authenticationRequest.getPassword());
	}
